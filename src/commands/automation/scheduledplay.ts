...
export const scheduledplay: MusicCommand = {
  meta: { id: "scheduled_play", category: "automation", description: "Schedule a single search query to start playing after a delay.", changesPlaybackState: true, requiresDb: false, requiresProvider: true },
  build: (b) => {
  ...
  execute: async (interaction) => {
    ...
    registerTimer(interaction.guildId!, "scheduled-play", minutes * 60 * 1000, async () => {
