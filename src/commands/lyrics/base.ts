...
export const base: MusicCommand = {
  meta: { id: "lyrics", category: "lyrics", description: "Show lyrics for the currently playing track.", changesPlaybackState: false, requiresDb: false, requiresProvider: true },
  build: () => {},
  execute: async (interaction) => {
    ...
    const body = (result.plainLyrics ?? "Synced-only — use /lyrics-tools synced").slice(0, 3800);
